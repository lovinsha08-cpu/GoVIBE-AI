...
import { Compass, Search, Gift, Map, Bot } from "lucide-react";
...
export default function TravelerDashboard(){
  const navigate=useNavigate(); const [assistantOpen,setAssistantOpen]=useState(false);
  return <main className="min-h-screen bg-[#EAF7EF] px-6 py-10 relative overflow-hidden">
    ...
    <section className="max-w-5xl mx-auto relative z-10">
      ...
      <motion.div initial={{opacity:0,y:15}} animate={{opacity:1,y:0}} transition={{delay:.15}} className="mt-10 max-w-xs"><VibeMeter/></motion.div>
